  ...
  return (
    <div className='auth'>
      ...
      <form onSubmit={handleSubmit} className='form' autoComplete="off">
        <input type='email' name="email" className='form__input form__input_theme_dark' value={data.email} onChange={handleChange} placeholder="Email"></input>
        <input type='password' name="password" className='form__input form__input_theme_dark' value={data.password} onChange={handleChange} placeholder="Пароль"></input>
